                        ...
                        <table id="datatable"
                            ...
                            @foreach($cou as $k=>$c)
                                <tr>
                                    ...
                                    <td>{{$c['code']}}</td>
                                    <td>{{\App\CPU\BackEndHelper::usd_to_currency($c['min_purchase'])}}</td>
                                    <td>{{\App\CPU\BackEndHelper::usd_to_currency($c['max_discount'])}}</td>
                                    <td>{{$c['discount_type']=='amount'?\App\CPU\BackEndHelper::usd_to_currency($c['discount']):$c['discount']}}</td>
                                    ...
                                    <td><label class="switch"><input type="checkbox" class="status"
                                        id="{{$c->id}}" <?php if ($c->published == 1) echo "checked" ?>><span
