...
@section('title','Vista previa del producto')
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <a href="{{url()->previous()}}" class="btn btn-primary float-right">
                        <i class="tio-back-ui"></i> Regresar
                    </a>
                </div>
            </div>
            <!-- Nav -->
                    ...
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-block">
                                ...
                                <p>de  {{$product->reviews->count()}} vistas
                    ...
                    <div class="col-md">
                        ...
                        <!-- Review Ratings -->
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="mr-3">4 estrella</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="mr-3">3 estrella</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="mr-3">2 estrella</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="mr-3">1 estrella</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                    ...
                    <div class="col-8 pt-2 border-left">
                        ...
                        <span> @if (count(json_decode($product->colors)) > 0)
                            <div class="row no-gutters">
                                <div class="col-2">
                                    <div class="product-description-label mt-2">Color disponible:
                                    </div>
                                </div>
                                <div class="col-10">
