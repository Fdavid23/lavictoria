...
class BusinessSettingsController extends Controller
{
    ...
    public function about_usUpdate(Request $data)
    {
        ...
        Toastr::success('Sobre nosotras actualizada con éxito!');
        return back();
    }
    ...
    public function sales_commission(Request $data)
    {
        ...
        Toastr::success('Comisión de ventas ¡Actualizado con éxito!');
        return redirect()->back();
    }
    ...
    public function updateCompanyCopyRight(Request $data)
    {
        ...
        Toastr::success('Derecho de autor de la empresa ¡Actualizado con éxito!');
        return redirect()->back();
    }
    ...
    public function update(Request $request, $name)
    {
        ...
        Toastr::success('Tienda de aplicaciones actualizada con éxito');
    ...
    {
        $old_img = BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0];
        $logo = ImageManager::update('company/', $old_img, 'png', 'company_web_Logo');
    ...
    {
        $old_img = BusinessSetting::where(['type' => 'company_footer_logo'])->pluck('value')[0];
        $logo = ImageManager::update('company/', $old_img, 'png', 'company_footer_Logo');
        BusinessSetting::where(['type' => 'company_footer_logo'])->update([
            'value' => $logo[0],
        ]);
        Toastr::success('¡Logotipo de pie de página actualizado con éxito!');
        return back();

    }
    public function uploadFavIcon(Request $data)
    {
        $old_img = BusinessSetting::where(['type' => 'company_fav_icon'])->pluck('value')[0];
        $logo = ImageManager::update('company/', $old_img, 'png', 'company_fav_icon');
        BusinessSetting::where(['type' => 'company_fav_icon'])->update([
            'value' => $logo[0],
        ]);
        Toastr::success('¡Ícono favorito actualizado con éxito!');
        return back();
    ...
    {
        $old_img = BusinessSetting::where(['type' => 'company_mobile_logo'])->pluck('value')[0];
        $logo = ImageManager::update('company/', $old_img, 'png', 'company_mobile_Logo');
